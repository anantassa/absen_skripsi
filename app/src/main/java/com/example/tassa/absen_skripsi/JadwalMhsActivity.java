...
public class JadwalMhsActivity extends AppCompatActivity {
    ...
    private static final String TAG = JadwalMhsActivity.class.getSimpleName();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_jadwal_mhs);
...
//        setSupportActionBar(toolbar);
        ...
        list.setOnItemClickListener(new AdapterView.OnItemClickListener(){
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                Intent i = new Intent(JadwalMhsActivity.this.getApplicationContext(),AbsenActivity.class);
...
//                        }
            ...
            public void onErrorResponse(VolleyError error) {
                ...
                Toast.makeText(JadwalMhsActivity.this,
...
//                params.put("id_wisata", id_wisata);
    ...
    private void SetListJadwal(ArrayList<HashMap<String, String>> daftarJadwal) {
        if(daftarJadwal.size() == 0) {
            adapter = new MatkulAdapter(JadwalMhsActivity.this, new ArrayList<HashMap<String, String>>());
//            emptyTV.setText("Tidak ada komentar");
            list.setAdapter(adapter);
            adapter.notifyDataSetInvalidated();
        } else {
            adapter = new MatkulAdapter(JadwalMhsActivity.this, daftarJadwal);
            list.setAdapter(adapter);
